...
<html>
    ...
    <body>
        ...
        <form action="Controlador" method="POST">
            ...
            <input type="number" id="precio" name="precio" min="0" value="${a.precio}"><br>
            <label for="marca">Marca</label><br>
            <input type="text" id="marca" name="marca" value="${a.marca}"><br>
            <label for="modelo">Modelo</label><br>
            <input type="text" id="modelo" name="modelo" value="${a.modelo}"><br>
